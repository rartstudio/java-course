...
public class JsonApiHelper {
    ...
    public static JsonApiListResponse createListResponse(String type, List<Map<String, Object>> attributeList,
            String message) {
    ...
    public static JsonApiSingleResponse createSingleResponse(String type, Map<String, Object> attributes,
            String message) {
