...
public class AuthController {
    ...
    public ResponseEntity<JsonApiSingleResponse> registerHandler(@Valid @RequestBody RegisterRequest req,
            HttpServletRequest request) {
        userService.registerUser(req);

        return ResponseEntity.status(HttpStatus.CREATED)
                .body(JsonApiHelper.createEmptySingleResponse("users", "-", "Success registering user"));
    }
    ...
    public ResponseEntity<JsonApiSingleResponse> validateHandler(@Valid @RequestBody ValidateRequest req) {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(JsonApiHelper.createEmptySingleResponse("users", "-", "Success validating user"));
    }
    ...
    public ResponseEntity<JsonApiSingleResponse> loginHandler(@Valid @RequestBody LoginRequest req,
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(JsonApiHelper.createSingleResponse("users", responseData, "Success login"));
    }
    ...
    public ResponseEntity<JsonApiSingleResponse> forgotPasswordHandler(@Valid @RequestBody ForgotPasswordRequest req) {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(JsonApiHelper.createEmptySingleResponse("user", "-", "Success send request reset password"));
    }
    ...
    public ResponseEntity<JsonApiSingleResponse> resetPasswordHandler(@Valid @RequestBody ResetPasswordRequest req) {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(JsonApiHelper.createEmptySingleResponse("user", "-", "Success reset password"));
    }
    ...
    public ResponseEntity<JsonApiSingleResponse> refreshTokenHandler(@Valid @RequestBody RefreshTokenRequest req) {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(JsonApiHelper.createSingleResponse("user", responseData, "Success refresh token"));
    }
